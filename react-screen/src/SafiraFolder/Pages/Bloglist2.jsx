...
const Bloglist2 = () => {
    ...
    const images = [
        '/assets/blog-big3.webp',
        '/assets/blog-big1.webp',
        '/assets/blog-big2.webp',
        '/assets/blog-big4.webp'
    ];
        ...
        <div className="header">
            ...
            <div className='main-productDiv'>
                <div className="bloglist-left">
                    ...
                    <a href="" id='blog-title'>Blog Image Post</a>
                    <p>18/01/2020 | <a href="" id='blog-title2'>eCommerce</a></p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis doloribus itaque nulla, ratione laboriosam quisquam dolorum expedita libero facere eius repellat qui suscipit illum a fuga odio velit. sint laboriosam explicabo asperiores eaque minus, magnam nesciunt.</p>
                    <button id='Read-btn'>Read More</button>

                    <img src="/assets/blog-big2.webp" alt="" />
                    <a href="" id='blog-title'>Libero Lorem</a>
                    <p>18/01/2020 | <a href="" id='blog-title2'>eCommerce</a></p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis doloribus itaque nulla, ratione laboriosam quisquam dolorum expedita libero facere eius repellat qui suscipit illum a fuga odio velit. sint laboriosam explicabo asperiores eaque minus, magnam nesciunt.</p>
                    <button id='Read-btn'>Read More</button>
                    ...
                    <a href="" id='blog-title'>Post With Gallery</a>
                    <p>18/01/2020 | <a href="" id='blog-title2'>eCommerce</a></p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis doloribus itaque nulla, ratione laboriosam quisquam dolorum expedita libero facere eius repellat qui suscipit illum a fuga odio velit. sint laboriosam explicabo asperiores eaque minus, magnam nesciunt.</p>
                    <button id='Read-btn'>Read More</button>


                    <img src="/assets/blog-big4.webp" alt="" />
                    <a href="" id='blog-title'>Post With Audio</a>
                    <p>18/01/2020 | <a href="" id='blog-title2'>eCommerce</a></p>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis doloribus itaque nulla, ratione laboriosam quisquam dolorum expedita libero facere eius repellat qui suscipit illum a fuga odio velit.</p>
                    <button id='Read-btn'>Read More</button>

                    <video controls poster="/assets/thumbnail.jpg">
                        <source src="https://www.youtube.com/" type="video/mp4" />
                    </video>
                    <a href="" id='blog-title'>Post With Video</a>
                    <p>18/01/2020 | <a href="" id='blog-title2'>eCommerce</a></p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis doloribus itaque nulla, ratione laboriosam quisquam dolorum expedita libero facere eius repellat qui suscipit illum a fuga odio velit. sint laboriosam explicabo asperiores eaque minus, magnam nesciunt.</p>
                    <button id='Read-btn'>Read More</button>

                    <img src="/assets/blog-big5.webp" alt="" />
                    <a href="" id='blog-title'>Maecenas ultricies</a>
                    <p>18/01/2020 | <a href="" id='blog-title2'>eCommerce</a></p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis doloribus itaque nulla, ratione laboriosam quisquam dolorum expedita libero facere eius repellat qui suscipit illum a fuga odio velit. sint laboriosam explicabo asperiores eaque minus, magnam nesciunt.</p>
                    <button id='Read-btn'>Read More</button>
